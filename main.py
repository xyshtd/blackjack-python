...
## dealer shoud draw card until he has 17 or more
...
def calc_score(cards):
    if sum(cards) == 21 and len(cards) == 2:
        return 0  #0 represening black jack
...
def compare_score(user_score, pc_score):
    if user_score == 0:
        ...
        return "Compuer BLACK JACK! you lose :("
    elif user_score > 21:
...
def play_game():
    ...
    #initial cards draw
    draw_card(2, user_cards)
    draw_card(2, pc_cards)
